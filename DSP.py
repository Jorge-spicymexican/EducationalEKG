"""" this code purpose is to create
# real time audio processing using "py -aduio"
# testing logic and simple case senerio
# reading audio data from a mircophone and play it on the speakers of the computer
"""
...
class Audio(object):
    def __init__(self, device=None, rate=None, chunk=4096, maxMemorySec=5):
        """
        Prime the Audio class to access audio data. Recording won't start
    ...
    def loadWAV(self, fname):
        ...
        print("loaded %.02f sec of data (rate=%dHz)" % (len(self.data) / self.rate,self.rate))
        self.initiate()
        return
...
if __name__ == "__main__":
    print("DSP.PY Should not RUN by itself, WARNING!.\n")